      ...
      <section id="destinations" className="bg-secondary/55 py-20">
        <div className="container">
          <div className="mb-8 flex items-end justify-between gap-4">
            <div><h2 className="font-display text-3xl font-semibold text-foreground sm:text-4xl">Featured stays</h2><p className="mt-2 text-base text-muted-foreground">Highly rated places our guests keep coming back to.</p></div>
