  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto w-full max-w-[1880px] px-5 py-5 sm:px-7 lg:px-9 xl:px-12">
        ...
        <div className="lg:grid lg:grid-cols-[minmax(210px,15fr)_minmax(0,85fr)] lg:gap-6 xl:grid-cols-[minmax(220px,12fr)_minmax(0,88fr)] xl:gap-7">
          ...
          <aside className="hidden lg:block"><div className="sticky top-[9.4rem] h-[calc(100vh-10.6rem)] min-h-[640px] overflow-hidden rounded-3xl border border-border bg-muted shadow-sm"><ListingsMap pins={pins} centerLat={selectedDestination?.latitude} centerLng={selectedDestination?.longitude} zoom={selectedDestination ? 10 : 11} className="h-full w-full rounded-3xl border-0" /></div></aside>
        </div>
      </div>
    </div>
  );
